...
def eald_worksheet():
    ...
    if st.button("Generate Worksheet"):
        ...
        prompt = (
            ...
            "- Write a 120–150 word paragraph about the topic. It MUST match the grade and english level inputed.\n"
            ...
            "- List 10 topic-related words, and next to each word, write its translation in {language}.\n"
            "- Ask: 'What do these words mean?'\n"
            "- Ask: 'Write a sentence for each of these words.'\n"
            "4. Mini Wordfind:\n"
            "Create a 6x6 or 8x8 letter grid where each row consists of letters separated by a single space. Wrap the entire grid in triple backticks (```) so that it appears in a fixed-width, monospaced format. This ensures that the columns remain perfectly aligned."
            "Additionally, hide 6–8 vocabulary words in the grid - either up, down, or left to right."
