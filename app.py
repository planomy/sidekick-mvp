...
if tool == "Lesson Builder":
    ...
    device_use = st.multiselect("Student Resource", ["Laptop/Tablet", "Textbook", "Worksheet"])
...
# ========== TOOL 5: UNIT PLANNER ==========
    ...
    if cloze_activity:
        worksheet_prompt = (
            ...
            "Randomly remove exactly ({num_questions}/10) of significant words from different parts of the passage—make sure the blanks are spread throughout the entire passage, not just in the first few sentences—and replace each removed word with a blank marked as '_____(n)'. "
